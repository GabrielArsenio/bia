        ...
        <v-navigation-drawer fixed :clipped="$vuetify.breakpoint.mdAndUp" app v-model="drawer">
            <v-list dense>
                ...
                <v-list-tile :to="{ path: '/niveis' }">
                    ...
                    <v-list-tile-content>
                        <v-list-tile-title>Niveis de criticidade</v-list-tile-title>
                    </v-list-tile-content>
                </v-list-tile>
                ...
                <v-list-tile>
                    ...
                    <v-list-tile-content>
                        <v-list-tile-title>Eventos por processo</v-list-tile-title>
                    </v-list-tile-content>
                </v-list-tile>
                ...
                <v-list-tile>
                    ...
                    <v-list-tile-content>
                        <v-list-tile-title>Eventos por ameaça</v-list-tile-title>
                    </v-list-tile-content>
                </v-list-tile>
                ...
                <v-list-tile>
                    ...
                    <v-list-tile-content>
                        <v-list-tile-title>Ameaças ao processo</v-list-tile-title>
                    </v-list-tile-content>
                </v-list-tile>
                ...
                <v-list-tile>
                    ...
                    <v-list-tile-content>
                        <v-list-tile-title>Mapa de riscos</v-list-tile-title>
                    </v-list-tile-content>
                </v-list-tile>
