<template>
    <div>
        <v-card-title>
            Eventos
            <v-spacer></v-spacer>
            <v-text-field v-model="search" append-icon="search" label="Pesquisar eventos" single-line hide-details></v-text-field>
        </v-card-title>
        ...
        <CadastroEvento :document="document" @cancel="document = false" @save="onSave"></CadastroEvento>
